...
import jp.go.ndl.lab.dl.back.domain.Book.autoIndex;
...
public class AnalyzeTOC {
    ...
    public List<Book.autoIndex> solve(List<String> tocs) throws Exception {
    ...
    public List<String> solve(int width) throws Exception {
        List<WindowResult> windows = new ArrayList<>();
