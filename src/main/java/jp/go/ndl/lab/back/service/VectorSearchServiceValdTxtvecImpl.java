...
@Service
@Slf4j
public class VectorSearchServiceValdTxtvecImpl implements VectorSearchServiceTxtvec {
	...
	public VectorSearchServiceValdTxtvecImpl(@Value("${valdEndPointTxtvec}") String endPoint) {
