...
public class RESTUtils {
     ...
     * エラーメッセージを返すためのクラス
     *
     * @param contentString テキスト内容を返す
     * @param streamingResponseBody アウトプットストリーム
     * @return ResponseEntity<> レスポンス情報
     */
    public static ResponseEntity<StreamingResponseBody> streamTextResponse(StreamingResponseBody streamingResponseBody) {
        HttpHeaders headers = new HttpHeaders();
    ...
    public static ResponseEntity<StreamingResponseBody> streamJsonResponse(StreamingResponseBody streamingResponseBody) {
        HttpHeaders headers = new HttpHeaders();
